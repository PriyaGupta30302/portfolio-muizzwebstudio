        ...
        */}
            ...
            >
                <div
                    ...
                    className={`w-32 h-16 rounded-full border border-white/80 p-1 flex items-center cursor-pointer transition-all duration-300 hover:scale-105 active:scale-95 ${isOn
                ...
                >
                    ...
                    <div
                        className={`w-14 h-14 rounded-full transition-all duration-300 transform ${isOn
